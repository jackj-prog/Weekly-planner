...
const PLAN = {
  ...
  /* ---------------------- BLOCK 1 · MARATHON --------------------------- */
  {
    ...
    satGym: [
      { fromWk: 1,  mins: 50, title: 'Gym — Lower B (light–moderate)', detail: 'Deadlift/RDL kept through Base only — no grinding PRs' },
      { fromWk: 11, mins: 20, title: 'Core + mobility (optional)',     detail: 'Lower B retired — running owns the legs' },
    ],
    ...
    templates: {
      ...
      0: [
        ...
        { t: '18:30', end: '19:30', title: 'Nan meal', detail: 'Family anchor — never scheduled over', cat: 'meal', quiet: true },
      ...
      1: [
        ...
        { t: '16:15', run: 'tue' },
        { after: true, end: '18:30', title: 'OU study', detail: 'Until Nan meal', cat: 'study', doable: true },
        { t: '18:30', end: '19:30', title: 'Nan meal', cat: 'meal', quiet: true },
        { t: '19:30', end: '20:45', title: 'Gym — Upper A', detail: 'Bench / row / OHP · drive over, no run-commute — legs are for running', cat: 'gym', doable: true, gym: 'upper' },
      ...
      4: [
        ...
        { t: '12:00', end: '13:00', title: 'Lunch', cat: 'meal', quiet: true },
        { t: '13:00', end: '14:30', title: 'Gym — Upper B', detail: 'Incline / pull-ups / arms — on the commute', cat: 'gym', doable: true, gym: 'upper' },
      ...
      5: [
        ...
        { t: '12:00', end: '13:00', title: 'Nan lunch', cat: 'meal', quiet: true },
    ...
    specialWeeks: {
      ...
      /* Weeks 26–27 — holiday template (off work Mon–Fri). Wake 08:00 ·
         ...
         block ~90 min · family evenings. Nan meals stay. Upper A slides
      ...
      30: {
        ...
        days: {
          ...
          5: { blocks: [
            ...
            { t: '12:00', end: '13:00', title: 'Nan carb lunch', cat: 'meal', quiet: true },
    ...
    namedTemplates: {
      ...
      holidayTue: [
        ...
        { t: '11:00', end: '12:00', title: 'Gym — Upper A (maintenance)', detail: 'Reduced sets — keep the strength, save the evening for family', cat: 'gym', doable: true, gym: 'upper' },
        { t: '13:00', end: '14:00', title: 'Lunch', cat: 'meal', quiet: true },
     ...
     normal · no hard running the full fortnight · gym returns light wk 2. */
  {
    ...
    templates: {
      ...
      1: [
        ...
        { t: '18:30', end: '19:30', title: 'Nan meal', cat: 'meal', quiet: true },
        { t: '19:30', end: '20:30', title: 'Wk 2 only: Gym — Upper A (light)', detail: 'Gym returns light in week 2', cat: 'gym', doable: true, recoveryWk2Gym: true },
  ...
  defaultWeek: {
    ...
    templates: {
      0: [
        ...
        { t: '13:00', end: '16:30', title: 'Work', cat: 'work', quiet: true },
        { t: '16:30', end: '17:00', title: 'Commute home', cat: 'work', quiet: true },
        { t: '17:00', end: '18:00', title: 'Gym — Lower A', detail: 'The split is back', cat: 'gym', doable: true },
        { t: '18:30', end: '19:30', title: 'Nan meal', cat: 'meal', quiet: true },
      ...
      5: [
        { t: '07:30', end: '08:00', title: 'Wake · Anki', cat: 'routine', quiet: true },
        { t: '08:00', end: '08:30', title: 'Breakfast', cat: 'meal', quiet: true },
        { t: '09:00', end: '10:00', title: 'Gym — Lower B', detail: 'Deadlifts are back', cat: 'gym', doable: true },
        { t: '12:00', end: '13:00', title: 'Nan lunch', cat: 'meal', quiet: true },
