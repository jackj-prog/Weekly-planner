    ...
    templates: {
      ...
      1: [
        ...
        { t: '19:30', end: '20:45', title: 'Gym — Upper A', cat: 'gym', doable: true, gym: 'upper',
          ...
          maintDetail: '3 reps in reserve — keep the strength',
          maintPlan: [
      ...
      4: [
        ...
        { t: '13:00', end: '14:30', title: 'Gym — Upper B', cat: 'gym', doable: true, gym: 'upper',
          ...
          plan: [
            ...
            { ex: 'Lateral raises', sets: '3 × 12' },
            { ex: 'EZ curls',       sets: '3 × 12' },
            { ex: 'Rope pushdowns', sets: '3 × 12' },
          ],
          maintDetail: 'In and out — the race is the priority',
          maintPlan: [
